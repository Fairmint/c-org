...
const PERMIT_SELL_TYPEHASH = keccak256(
  toUtf8Bytes(
    "sellFrom(address _from,address _to,uint256 _quantityToSell, uint256 _minCurrencyReturned,uint256 _nonce,uint256 _deadline)"
  )
);
...
contract("dat / sellFrom", (accounts) => {
  let contracts;
